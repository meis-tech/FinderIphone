...
//    NSLog(@"Discovered name : %@", name);
    ...
    if(bleUser == nil) {
//        NSLog(@"Adding ble user: %s", "DICKSHOLES");
...
//        NSLog(@"check: %@", bleUser.peripheralId);
...
//                NSLog(@"check2: bleUser not identified");
...
//                    NSLog(@"check3: we can be indentified and added");
